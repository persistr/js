...
const endpoints = {
	...
	watchObject: require('./object/watch.js'),
...
class API {
  ...
  async destroyObject (params) {
    return Errors.handle(async () => endpoints.destroyObject(this.http, params))
  }
  ...
  async watchObject (params) {
    return Errors.handle(async () => endpoints.watchObject(this.http, params))
  }

  async writeObject (params) {
    return Errors.handle(async () => endpoints.writeObject(this.http, params))
  }
